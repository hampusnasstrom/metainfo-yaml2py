...
def _to_camel_case(input_string: str) -> str:
    ...
    Args:
        input_string (str): The input string with space, - or _ for seperation.
...
def parse_section(section_name: str, section_dict: dict) -> str:
    ...
    code = ""
    sub_section_names = {}
    if "sub_sections" in section_dict:
        for sub_section in section_dict["sub_sections"]:
            sub_section_names[sub_section] = _to_camel_case(sub_section)
            sub_section_dict = section_dict["sub_sections"][sub_section]["section"]
            code += parse_section(section_name=sub_section_names[sub_section],
                                    section_dict=sub_section_dict) + '\n'
    base_sections = []
    for base_section in section_dict.get("base_sections", []):
